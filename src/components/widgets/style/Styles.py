...
def blendColors(color1: QColor, color2: QColor, ratio: float):
...
class GeneralStyleMixin:
    ...
    @staticmethod
    def applyStyle(widget: QtWidgets.QWidget):
        ...
        for i in range(num_steps + 1):
            ...
            color = blendColors(GeneralStyleMixin.main_color, GeneralStyleMixin.accent_color, blend_factor)
